"""
MCP Tools for Local Mover Domain.

This module provides MCP-compliant tools specific to the Local Mover domain.
"""
...
class LocalMoverTools:
    """Collection of MCP-compliant tools for Local Mover domain."""

    @register_tool(
        name="example_local_mover_tool",
        description="Example tool for Local Mover domain",
        domains=["local_mover"],
        standard="DomainStandards"
    )
    def example_local_mover_tool(
        parameter1: str,
        parameter2: List[str],
        parameter3: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        Example tool function for Local Mover domain.
...
def register_local_mover_tools() -> List[str]:
    """Register all Local Mover tools and return their names.
    ...
    tools = [
        LocalMoverTools.example_local_mover_tool
    ]
