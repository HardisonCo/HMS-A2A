"""
MCP Tools for Florist Domain.

This module provides MCP-compliant tools specific to the Florist domain.
"""
...
class FloristTools:
    """Collection of MCP-compliant tools for Florist domain."""

    @register_tool(
        name="example_florist_tool",
        description="Example tool for Florist domain",
        domains=["florist"],
        standard="DomainStandards"
    )
    def example_florist_tool(
        parameter1: str,
        parameter2: List[str],
        parameter3: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        Example tool function for Florist domain.
...
def register_florist_tools() -> List[str]:
    """Register all Florist tools and return their names.
    ...
    tools = [
        FloristTools.example_florist_tool
    ]
